...
export default function loopExtension(pi: ExtensionAPI): void {
  ...
  pi.registerTool({
    ...
    promptSnippet:
      "Stop an active /loop cycle once the breakout condition is met.",
    promptGuidelines: [
      "Only call signal_loop_success when the current loop breakout condition is explicitly satisfied.",
    ],
