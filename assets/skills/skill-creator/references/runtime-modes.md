...
Read this file only when working in Claude.ai, Cowork, or another environment where subagents/browser/server behavior differs from the default Claude Code workflow.
