...
> **Precedence:** Treat this directory as an opinionated package-scale recipe library, not universal script policy. Repository instructions, `rust-toolchain*`, `Cargo.toml`, configured gates, existing dependencies, and nearby working code override its stack and style defaults.
