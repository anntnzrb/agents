...
- **[pki](https://clan.lol/docs/26.05/services/official/pki)**: Generates TLS certificates for all
  internal endpoints using a static Root CA. No daemon required.
- **[dm-dns](https://clan.lol/docs/26.05/services/official/dm-dns)**: Collects endpoint exports from
  all services and distributes DNS records via data-mesher, so every machine can
  resolve internal hostnames.
- **[data-mesher](https://clan.lol/docs/26.05/services/official/data-mesher)**: The underlying
...
[yggdrasil](https://clan.lol/docs/26.05/services/official/yggdrasil), a VPN, or any other networking
setup.
...
See the [exports guide](services/exports.md) for details on the export
system.
