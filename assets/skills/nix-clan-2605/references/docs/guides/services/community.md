...
## Table of Contents
- [Authoring a 'clan.service' module](#authoring-a-clanservice-module)
  ...
  - [Passing `self` or `pkgs` to the module](#passing-self-or-pkgs-to-the-module)
    - [Using `importApply`](#using-importapply)
    - [Using a wrapper module](#using-a-wrapper-module)
  - [Example: A machine-type service](#example-a-machine-type-service)
  - [Sharing Data Between Machines with Exports](#sharing-data-between-machines-with-exports)
...
For the full specification and current state see: **[Service Author Reference](https://clan.lol/docs/26.05/reference/options/clan_service)**
...
For more attributes see: **[Service Author Reference](https://clan.lol/docs/26.05/reference/options/clan_service)**
...
- [Reference Documentation for Service Authors](https://clan.lol/docs/26.05/reference/options/clan_service)
