...
clanLib.selectExports { serviceName = "myservice"; } exports
  # =>  {
  #   <scopes> :: <some data>
  # }
...
For real-world use cases, see the [clan-services](https://git.clan.lol/clan/clan-core/src/branch/26.05/clanServices)

### Further Reading

- [Service Author Reference](https://clan.lol/docs/26.05/reference/options/clan_service)
