...
const definitionForMessage = (message: string): HintDefinition | undefined =>
  HINT_DEFINITION_LIST.find((definition) =>
    definition.messagePattern.test(message),
  );

export const formatToolSignature = (
  toolName: GuardedNativeTool,
...
export const agentHintForWarning = (
  message: string,
  tools: readonly ToolLike[] = [],
): string => {
