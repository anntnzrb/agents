...
4. Use `assets/skills/deepswe-live/SKILL.md`, fetch the current supported release, and compare published `pass_at_1`, confidence intervals, agent steps, and output tokens. Preserve model, reasoning effort, harness, and configuration identity.
