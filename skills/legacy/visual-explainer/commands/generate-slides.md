...
Before writing HTML, read `templates/slide-deck.html`,
`references/slide-patterns.md`, and only needed shared CSS/library sections.
...
Write to `~/.local/share/agentium/visual-explainer/diagrams/` and open in the browser.
