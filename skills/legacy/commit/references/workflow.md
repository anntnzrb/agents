...
Read this before planning or executing a commit sequence, writing messages, validating changes, handling changelogs, splitting work, or recovering from edge cases.
...
Detailed message examples live in `references/git.md` and repo history; keep workflow decisions here.
