...
Corpus normalized from source ledger `resources/source_registry.json`.

Source roles: official patch notes + PowerPyx guides for high-impact version/trophy facts; Fextra for boss/weapon cross-checks. Community/video links: corroboration only; no prose or unlicensed datasets copied.
...
Exact elemental absorption values intentionally remain unknown where cited sources do not establish them.
