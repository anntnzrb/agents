...
- [Step 1. Create a Server on Hetzner](#step-1-create-a-server-on-hetzner)
...
Then, farther down, add the following and replace the IP address with your Hetzner server's IP address:
