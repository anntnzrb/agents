...
- [The Problem Vars Solves](#the-problem-vars-solves)
- [Your First Var: The Root Password](#your-first-var-the-root-password)
- [Viewing Your Vars](#viewing-your-vars)
- [Retrieving a Secret](#retrieving-a-secret)
- [How Vars Are Stored](#how-vars-are-stored)
- [The Vars Workflow](#the-vars-workflow)
- [Common Vars Commands](#common-vars-commands)
- [The Age Key](#the-age-key)
- [Example: WiFi Credentials](#example-wifi-credentials)
- [Example: SSH Host Keys](#example-ssh-host-keys)
- [Regenerating Vars](#regenerating-vars)
- [How Vars Connect to Services](#how-vars-connect-to-services)
- [Sample Test-Run Walkthrough Without Installing Machines](#sample-test-run-walkthrough-without-installing-machines)
...
```nix
{
  ...
  inventory.instances = {
    ...
    # Docs: https://clan.lol/docs/26.05/latest/services/official/zerotier/
    ...
    # Docs: https://clan.lol/docs/26.05/latest/services/official/tor/
