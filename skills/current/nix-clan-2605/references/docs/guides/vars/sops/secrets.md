...
Clan can also be configured to be used with other secret store [backends](https://clan.lol/docs/26.05/reference/clan.core/vars#secretstore).

<!-- nix-clan-updater:toc:start -->
## Table of Contents
- [Create Your Admin Keypair](#create-your-admin-keypair)
- [Add Your Public Key(s)](#add-your-public-keys)
- [Manage Your Public Key(s)](#manage-your-public-keys)
- [Adding a Secret](#adding-a-secret)
- [Retrieving a Stored Secret](#retrieving-a-stored-secret)
...
- [Advanced](#advanced)
  ...
  - [Migration: Importing existing sops-based keys / sops-nix](#migration-importing-existing-sops-based-keys-sops-nix)
- [Indepth Explanation](#indepth-explanation)
  - [Inherited implications](#inherited-implications)
  - [Machine and user keys](#machine-and-user-keys)
